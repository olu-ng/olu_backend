        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfessionTags = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Blocks_AspNetUsers_ApplicationUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuperAdminProfiles", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PushSubscriptions_IdentityUser_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ParentMsgId = table.Column<int>(type: "int", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatThreads_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blocks_ApplicationUserId1",
                table: "Blocks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatThreads_ApplicationUserId",
                table: "ChatThreads",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatThreads_ParentMsgId",
                table: "ChatThreads",
                column: "ParentMsgId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ChatThreads_Messages_ParentMsgId",
                table: "ChatThreads",
                column: "ParentMsgId",
                principalTable: "Messages",
                principalColumn: "Id",
